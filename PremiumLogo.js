(function () {
    ...
    if (!window.YouTubeEnhancerModule || !window.YouTubeEnhancerCoreInstance) {
        console.error("[PremiumLogo] Core không tìm thấy. Vui lòng đảm bảo YouTubeEnhancerCore.js được tải trước.");
        return;
    }
    ...
    class PremiumLogoModule extends Module {
        constructor() {
            super("premium-logo", "Logo YouTube Premium", true);
        }
        ...
        stop() {
            document.querySelectorAll("style").forEach((style) => {
                if (style.textContent.includes("#logo-container .logo")) {
                    style.remove();
                }
            });
        }
    ...
    core.registerModule(PremiumLogoModule);
})();